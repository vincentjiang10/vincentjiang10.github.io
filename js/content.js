const Content = {
  ...
  PAC_CAMEL: {
    ...
    buttons: [
      {
        href: "https://github.com/vjiang10/pac-camel",
  ...
  TERRAIN_MAP: {
    ...
    logoRef: "https://github.com/vjiang10/terrain-map",
    ...
    buttons: [
      {
        href: "https://github.com/vjiang10/terrain-map",
        icon: "fa-github-square",
      },
    ],
    bodyText:
  ...
  CHOICE_GAME: {
    ...
    buttons: [
      {
        href: "https://github.com/vjiang10/choice-game",
        icon: "fa-github-square",
      },
    ],
    bodyText:
